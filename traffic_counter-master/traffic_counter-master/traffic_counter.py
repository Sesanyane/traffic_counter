...
cap_2 =cv2.VideoCapture('surveillance.m4v')
...
image_2 = cv2.resize(frame_2, (0, 0), None, ratio, ratio)
width2, height2, channels = image.shape
width2_2, height2_2, channels_2 = image_2.shape

video = cv2.VideoWriter('traffic_counter.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), fps, (height2, width2), 1)
video_2 = cv2.VideoWriter('traffic_counter.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), fps, (height2_2, width2_2),1)
